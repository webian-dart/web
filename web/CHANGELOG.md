...
1. fix #877 'Web.interceptors.errorLock.lock()'
2. fix #851
3. fix #641
...
- Fix #467
- Export `WebForNative` and `WebForBrowser` classes.
...
- Support Flutter Web.
- Extract [CookieManager](https://github.com/tautalos/Web/tree/master/plugins/cookie_manager) into a separate package（No need for Flutter Web）.
- Provides a [HTTP/2.0 HttpClientAdapter](https://github.com/tautalos/Web/tree/master/plugins/http2_adapter).
...
- fix https://github.com/tautalos/Web/issues/316

# 2.1.5

- fix https://github.com/tautalos/Web/issues/309
...
- change "Web.transFormer" to "Web.transformer"
- change deprecated "UTF8" to "utf8"

## 0.1.5

- add `clear` method for Web instance
