...
/// HttpAdapter is a bridge between Web and HttpClient.
///
/// Web: Implements a standard and friendly API for developers.
///
...
///
/// The default HttpClientAdapter for Web is [DefaultHttpClientAdapter].
///
/// ```dart
/// Web.httpClientAdapter = DefaultHttpClientAdapter();
/// ```
